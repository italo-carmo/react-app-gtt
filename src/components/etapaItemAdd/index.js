...
export default function EtapaItem({dep, pouso, alternativa, horaDep, horaPouso, index, edit, del}) {
  var complete = false
  ...
  return (
        <div className={complete ? "view-etapa complete" : "view-etapa" } >
            <div className={complete ? "complete-text" : "" } style={{color:'#000'}}>{index +1}- {horaDep} {dep} - {horaPouso} {pouso}</div>
